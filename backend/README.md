...
| Blockchain mirror + Solana lifecycle API | ✅ |
| Тесты (160 тестов: 100% passing) | ✅ |

См. также [BLOCKCHAIN_INTEGRATION.md](/home/nikcnn/Work/TokenMind/BLOCKCHAIN_INTEGRATION.md) для wallet-signed on-chain flow.
