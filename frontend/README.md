...
5. Admin review
6. Wallet-signed tokenization after approval
7. Backend-backed marketplace listing and purchases after mint
...
Актуальная интеграция живёт в корневом `app/` каталоге и использует backend API + Phantom wallet flow.
